<div class="bg-gray-800 w-64 h-screen fixed">
    <div class="flex flex-col items-start mt-8 px-4 space-y-2">
        <a href="{{ route('admin.dashboard') }}" class="text-gray-300 hover:text-gray-100 block px-4 py-2 rounded-md">Home</a>
        <a href="{{ route('admin.manageUsers') }}" class="text-gray-300 hover:text-gray-100 block px-4 py-2 rounded-md">Manage Users</a>
        <a href="{{ route('admin.analytics') }}" class="text-gray-300 hover:text-gray-100 block px-4 py-2 rounded-md">Analytics</a>
